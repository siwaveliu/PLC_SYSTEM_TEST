...
def check(tdr, tb, test_data,result_file,siggen_plc):
    ...
    if test_narrow:
        ...
        narrow_mask_file = "tonemask_narrow_b0_"+ NARROW_SOURCE +".txt"
        ###parameters ：tone_mask_file,ValidCarrierNum,band,narrow_f,afe_type
        tonemask_b0 = tonemask_narrow.ToneMaskConfig(narrow_mask_file,411,0,NARROW_SOURCE,config.DUT_AFE_TYPE)
        tonemask_b0.run()
