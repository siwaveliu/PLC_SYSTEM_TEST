...
'''
3.2.3.1 CCO 的 CSMA 时隙访问测试
验证待测 CCO 所发送的 SOF 帧是否在中央信标的 CSMA 时隙内
'''
def run(tb):
    """
    run function.
    ...
    while True:
        ...
        if result is not None:
            ...
            if ("PLC_MPDU_BEACON" == fc.mpdu_type):
                ...
                assert curr_beacon is not None, "no beacon"
                ...
                correct_time = plc_packet_helper.check_sof_time(sof_start_time, sof_end_time, 1, curr_beacon)
