...
def run(tb):
    ...
    assert nmm.body.result == 'NML_ASSOCIATION_KO_NOT_IN_WL' or nmm.body.result == 'NML_ASSOCIATION_OK'
    ...
    req_dict['body']['mac'] = '00-00-00-00-00-03'
    ...
    assert nmm.body.mac_sta == '00-00-00-00-00-03'
