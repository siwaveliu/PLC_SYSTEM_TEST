...
def run(tb):
    ...
    burst function test by hanxiongchuan
    """
    ...
    if RF_SOURCE:
        ...
        siggen_plc = siggen_config_rf(SG_ADDR,WV_FORM,SAMPLE_RATE,CENTER_FREQ,LEVEL)
    else:
        SAMPLE_RATE = SOF_VERSION/2
